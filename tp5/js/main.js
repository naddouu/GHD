...
window.onload = function () {
    document.querySelector(
      ...
      }&zoom=7&size=400x300&scale=2&key=ed6f22c72bdea0a7b18321f7e38cb5bf`;
    ...
    app = new Vue({
        ...
        methods: {
            ...
            remove: function (_city) {  // on utilise 'filter' pour retourne une liste avec tous
                //  les items ayant un nom différent de _city.name
